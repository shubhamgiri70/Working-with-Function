...
function calculateMoviesToWatch(age, moviesPerWeek) {
  ...
  const weeksRemaining = weeksInYear * yearsRemaining;

  return `movies you will watch ${weeksRemaining * moviesPerWeek}`;
}
...
function min(num1 = 0, num2 = 0) {
  if (num1 > num2) {
    return `num2 has minium value`;
  } else {
    return `num1 has minium value`;
  }
}
